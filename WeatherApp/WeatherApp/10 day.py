...
def parse():
    URL = 'https://weather.com/weather/tenday/l/e958ec105aef48bbab18247e979b1e10a163e36cab17882a4c901f2b2cb1954f'
    HEADERS = {
        ...
        for i in todayDiv3:
            data3.append({
                'forcast': [
                            ...
                            i.find('div', class_='DetailsSummary--temperature--3FMlw').get_text(strip=True),
